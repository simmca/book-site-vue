Book recommendation single page application built to practice Vue, data stores, and routers. Built using Visual Studio Code. Utilizing HTML, CSS, Javascript, and Vue.
